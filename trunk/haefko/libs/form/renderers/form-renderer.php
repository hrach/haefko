...
require_once dirname(__FILE__) . '/iform-renderer.php';
...
abstract class FormRenderer extends Object implements IFormRenderer
{
	...
	public function render($part = null)
	{
		...
		switch ($part) {
			...
			case 'part': return $this->renderPart(array_shift($attrs), array_shift($attrs), array_shift($attrs));
			case 'pair': return $this->renderPair(array_shift($attrs));
			case 'form':
