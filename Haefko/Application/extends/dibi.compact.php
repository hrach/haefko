 ...
 * @package    dibi
 * @version    0.9 (revision 136 released on 2008/07/23 00:37:14)
 */
...
static$lowerCase=TRUE;private$connection;protected$name;protected$primary;protected$primaryModifier='%i';protected$blankRow=array();protected$types=array();public
function
...
function
insert($data){$this->connection->query('INSERT INTO %n',$this->name,'%v',$this->prepare($data));if($this->primary){return$this->connection->insertId();}}public
function
...
VERSION='0.9',REVISION='136 released on 2008/07/23 00:37:14';private
